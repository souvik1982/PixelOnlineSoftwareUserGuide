...
\end{center}
\caption{Low Level GUI for the FEC board at VME base address 0x1c000000 in the crate controlled
...
\item The data volume should be small. we.e. the data
...
(we performed trials were we lowered Vana on all
...
\item We need to decide how many pixels we include in the triming.
      we.e. setting Vtrim large enough so that the trim bits can
